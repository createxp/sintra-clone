...
export default function SoshieAgentPage() {
  return (
    <div className="flex min-h-screen flex-col bg-neutral-50">
      <NavbarLight />
      <main className="w-full flex-1 px-4 mt-[88px] pb-8 md:px-10 lg:px-10 xl:px-[120px] ">
        <div className="relative mx-auto w-full max-w-7xl overflow-hidden rounded-3xl">
          ...
          <Image
            ...
            className="w-full h-full object-cover max-md:w-full max-md:h-full max-md:object-cover"
          />
