...
const Automations = () => {
  return (
    <div className="w-full h-full bg-black pt-12 relative">
      ...
      />
      <div className="flex flex-row items-center w-full justify-center gap-2 absolute xl:-bottom-415 md:-top-56 md:text-center lg:-top-180 md:bottom-24 bottom-16 z-14 -top-60">
