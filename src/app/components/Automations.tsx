...
const Automations = () => {
  return (
    <div className="w-full h-full bg-black pt-12 relative">
      ...
      />
      <div className="flex flex-row items-center w-full justify-center gap-2 absolute xl:-bottom-190 md:-bottom-120 md:text-center lg:-bottom-160 top-80 z-14 ">
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <p className="text-neutral-400 text-[20px] px-[21.28px]  tracking-tight font-walsham lg:max-w-3xl md:text-[20.8px] lg:text-[20.8px] xl:text-[20.8px] lg:text-center leading-[1.4] md:leading-[1.1] md:px-14 lg:px-0 lg:leading-[1.4]">
