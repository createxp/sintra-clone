...
const Business = () => {
  return (
    <>
      <div className="relative overflow-hidden w-full min-h-screen xl:px-[96px]">
        <div className="flex flex-col items-center justify-center xl:px-[100px] w-full px-4 ">
          <h1 className="xl:text-[48px] text-center md:text-left font-walsham text-white w-full text-[30px] leading-[1.1">
        ...
        {/* Cards section */}
        <div className="flex flex-col lg:flex-row items-start justify-center gap-10 lg:gap-12 xl:gap-16 px-4 md:px-12 xl:px-[96px] mt-12 md:mt-16 xl:mt-20 pb-16 xl:pb-24">
          {cards.map((card, index) => {
            ...
            return (
              <div
                key={card.number}
                className={`w-full lg:max-w-none lg:w-1/3 xl:w-[400px] mx-auto lg:mx-0 flex lg:flex-col items-start gap-6 lg:gap-0 ${
                  isEven
