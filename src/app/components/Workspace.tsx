...
const Workspace = () => {
  return (
    <div className="relative bg-black w-full min-h-[800px] md:min-h-[900px] lg:min-h-[900px] xl:min-h-[1000px] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-end h-full px-[20px] md:px-[51px] lg:px-[51px] xl:px-[72px] pb-8 md:pb-12 lg:pb-24 xl:pt-[490px] pt-[400px] md:pt-[600px] lg:pt-0">
