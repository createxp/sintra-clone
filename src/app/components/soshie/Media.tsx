  ...
  return (
    <section className="w-full bg-[#fafafa] py-16 md:py-24 lg:py-32 px-4 md:px-10 xl:px-[76px]">
      <div className="max-w-[1440px] mx-auto">
        {/* Section Heading */}
        <motion.div className="text-left lg:text-center mb-12 md:mb-16 lg:mb-20">
          <div className="inline-flex justify-center items-center gap-2 mb-4 lg:mx-auto">
            <span className="font-walsham text-[14px] md:text-[16px] text-[#191919] font-medium">Excellent</span>
            <svg
              role="img"
              viewBox="0 0 251 46"
              xmlns="http://www.w3.org/2000/svg"
              className="h-[22px] md:h-[24px] w-auto"
            >
              <title lang="en-US">4.5 out of 5 star rating on Trustpilot</title>
              <g className="tp-star">
          ...
          <h2 className="font-walsham text-black text-[30px] md:text-[44px] lg:text-[48px] xl:text-[48px] leading-[1.15] tracking-tight lg:max-w-2xl mx-auto">
