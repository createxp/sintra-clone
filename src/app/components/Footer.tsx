...
const Footer = () => {
  return (
    <footer className="bg-white h-screen w-full py-16 px-6 md:px-10 lg:py-[128px] lg:px-16 xl:px-[76px]">
      <div className=" mx-auto lg:px-11">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-x-8 gap-y-12 lg:gap-x-[80px]">
          <div className="col-span-2 md:col-span-3 lg:col-span-1">
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <p className="text-neutral-600 text-[14px] font-walsham">
                  Copyright © 2026
                </p>
                <p className="text-neutral-600 text-[14px] font-walsham">
                  PlayOS, Inc.
          ...
          <div className="">
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <a
                  href="#"
                  className="text-neutral-600 text-[17px] font-walsham hover:text-primary transition-colors"
                >
                  Sintra X
                </a>
              </li>
        ...
        <div className="mt-16 lg:mt-40">
          <svg
            role="img"
            viewBox="0 0 126 31"
            aria-labelledby="trustpilotLogo-qi2djcg3m5p"
            width="126"
            height="31"
            xmlns="http://www.w3.org/2000/svg"
            // className="absolute h-full w-full left-0 top-0"
          >
            <title id="trustpilotLogo-qi2djcg3m5p">Trustpilot</title>
            <path
          ...
          <a
            ...
            className="block w-[200px] md:w-[220px] lg:w-[255px] h-auto"
          >
            <div className="relative w-full">
              ...
              <p className="text-neutral-700 text-[12px] font-walsham mt-1">
                TrustScore 4.5 | 8,330 reviews
              </p>
            </div>
          </a>
        </div>
